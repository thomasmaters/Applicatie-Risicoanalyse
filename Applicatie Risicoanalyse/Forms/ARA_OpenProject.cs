...
namespace Applicatie_Risicoanalyse.Forms
{
    public partial class ARA_OpenProject : Form
    {
        ...
        /// <summary>
        /// Handler when the user updates the project details of a project.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void OpenProjectDataGrid_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                string projectName = (String)this.OpenProjectDataGrid.Rows[e.RowIndex].Cells["machineNumberDataGridViewTextBoxColumn"].Value;
